...
<form class="form-horizontal" method="POST" action="{{ URL::to('groups/create') }}" accept-charset="UTF-8">
    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-md-offset-2 col-md-10">
                <button tabindex="3" type="submit" class="btn btn-primary">Create</button>
            </div>
        </div>
    </fieldset>
</form>
